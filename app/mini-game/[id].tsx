...
export default function MiniGameScreen() {
  ...
  const handleLogicPuzzleNavigation = (difficulty: string) => {
    // Use direct navigation instead of useEffect to avoid hook order issues
    router.push(`/mini-game/logic-puzzles/${difficulty}`);
  };
        ...
        return (
          <View style={styles.placeholderContainer}>
            ...
            <TouchableOpacity 
              ...
              onPress={() => handleLogicPuzzleNavigation('easy')}
            >
              <Text style={styles.buttonText}>Start Puzzles</Text>
            </TouchableOpacity>
          </View>
        );
      case 'logic_puzzles_medium':
        return (
          <View style={styles.placeholderContainer}>
            ...
            <TouchableOpacity 
              style={styles.startButton}
              onPress={() => handleLogicPuzzleNavigation('medium')}
            >
              <Text style={styles.buttonText}>Start Puzzles</Text>
            </TouchableOpacity>
          </View>
      ...
      case 'logic_puzzles_hard':
        return (
          <View style={styles.placeholderContainer}>
            ...
            <TouchableOpacity 
              style={styles.startButton}
              onPress={() => handleLogicPuzzleNavigation('hard')}
            >
              <Text style={styles.buttonText}>Start Puzzles</Text>
            </TouchableOpacity>
          </View>
